...
namespace WebViewer
{
    public class WebBrowserHostUIHandler : Native.IDocHostUIHandler
    {
        ...
        public bool OpenNewWindowSuppressed { get; set; }

        private void OnNavigated(object sender, NavigationEventArgs e)
        {
            SetSilent(Browser, ScriptErrorsSuppressed, OpenNewWindowSuppressed);
        }
        ...
        private static void WebBrowserPtr_NewWindow2(ref object ppDisp, ref bool Cancel)
        { Cancel = true; }
    }
